...
public class Bullet extends ImageView implements ISprite {
    ...
    public void move(InvaderGroup.MoveDirection direction){
        ...
        int yEndPosition = direction == InvaderGroup.MoveDirection.DOWN ? Integer.parseInt(SpaceInvaders.getSettings("invadergroup.border.yend")) + 150 : Integer.parseInt(SpaceInvaders.getSettings("invadergroup.border.ystart"));
